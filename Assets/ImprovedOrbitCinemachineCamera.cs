...
/// <summary>
/// This is a slight modification of the ThirdPersonOrbitCamBasic from the 3rd Person + Fly asset.
/// It differs in that the camera does not zoom in to avoid obstructions; this was causing sudden
/// camera movements.
///
/// This was done by replacing DoubleViewingPosCheck. It couldn't be done by overriding because
/// that method isn't virtual.
/// </summary>
public class ImprovedOrbitCinemachineCamera : MonoBehaviour
{
	...
	{
		// For this camera, all positions are valid
		return true;
	}
